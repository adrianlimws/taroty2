<template>
  <div class="text-center p-4">
    <!-- Question prompt -->
    <p class="text-xl bg-yellow-100 p-4 rounded mb-8">"Discover your complete reading with the Celtic Cross spread"</p>
    ...
    <transition name="fade">
      <div v-if="spreadCards.length" class="mt-8 mx-auto container">
        <hr class="mb-8">
          ...
          <div v-for="(card, index) in spreadCards" :key="index"
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border-0.5">
              ...
              <div class="p-4">
                ...
                <h6 class="text-gray-600 mb-2 font-bold"> {{ positions[index] }}</h6>
